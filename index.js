  ...
  if (reaction.message.interaction != undefined) {
    ...
    if (
      ...
      if (upvotes - downvotes >= channeldb.popamount) {
        ...
        let author =
          embed.data.author.icon_url + "&sc=" + channeldb.suggestchannel;
      ...
      if (upvotes - downvotes >= channeldb.adamount && !alreadydone) {
        ...
        if (channeldb.acceptchannel != undefined) {
          ...
          let acceptchannel = await guild.channels.fetch(
            channeldb.acceptchannel
          );
          acceptchannel.send({
            content: " ",
            embeds: [embed],
